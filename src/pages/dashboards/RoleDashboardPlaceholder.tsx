    ...
    <DashboardShell defaultItem="overview" primaryActionLabel="New inspection">
      {() => (
        <div className="stagger">
          ...
          <h1 className="mt-2 font-sans font-bold text-[44px] leading-[1.05] tracking-tight text-text-primary">
            Welcome to the <span className="italic text-text-secondary">{role.label}</span> workspace.
          </h1>
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 rounded-xl border hairline border-dashed bg-white/50 p-12">
              <div className="text-[11px] font-medium uppercase tracking-[0.18em] text-text-secondary">
                Reserved
              </div>
              <div className="mt-2 font-sans font-bold text-[36px] leading-tight tracking-tight text-text-secondary">
                Workspace content.
              </div>
            ...
            <div className="rounded-xl border hairline bg-white p-5">
              <div className="flex items-center justify-between">
                <div className="text-[14px] font-medium text-text-primary">Status</div>
              ...
              <ul className="mt-5 space-y-2.5 text-[12px]">
                {[
                  ...
                  <li key={i} className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-[10px] font-mono uppercase ${ tone === 'green' ? 'text-status-pass' : 'text-warning' }`}
                    >
