...
export function SafetyInspectorDashboard() {
  return (
    <Routes>
      ...
      <Route path="inspections/:inspectionId" element={<InspectionExecutionPage domain="safety" />} />
...
function MyInspectionsListInShell() {
  return (
    <DashboardShell defaultItem="inspections">
      {() => <MyInspectionsListPage domain="safety" />}
    </DashboardShell>
  )
}
