  ...
  return (
    ...
    >
      <form id="department-form" onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <label className="block text-[11px] font-medium uppercase tracking-[0.12em] text-text-secondary mb-2">Department kind</label>
        ...
        <div>
          <label className="block text-[11px] font-medium uppercase tracking-[0.12em] text-text-secondary mb-2">Head of Department</label>
          <div className="relative">
            <select
              value={headId}
        ...
        <div>
          <label className="block text-[11px] font-medium uppercase tracking-[0.12em] text-text-secondary mb-2">Areas</label>
          ...
          {areas.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-2">
              {areas.map(area => (
                <div key={area} className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-accent-light text-[12px] font-medium text-text-secondary">
                  {area}
                  <button type="button" onClick={() => removeArea(area)} className="text-text-secondary hover:text-text-primary">
